#ifndef ADJMATRIXDIRGRAPH_H_INCLUDE
#define ADJMATRIXDIRGRAPH_H_INCLUDE
...
public:
	AdjMatrixDirGraph();
	AdjMatrixDirGraph(ElemType * vertex, int vexNum);
	~AdjMatrixDirGraph();
//特征函数
	//得
...
template <class ElemType>
void AdjMatrixDirGraph<ElemType>::destroyGraphHelp() {
	delete[] m_elems;
	m_elems = NULL;
...
//函数功能: 深度优先搜索辅助函数
template <class ElemType>
void AdjMatrixDirGraph<ElemType>::DFSHelp(int vertex, void(*visit)(ElemType &)) {
#ifdef DEBUG
...
//函数功能: 实现广度优先搜索
template <class ElemType>
void AdjMatrixDirGraph<ElemType>::BFSHelp(int vertex, void(*visit)(ElemType &)) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	if (m_visited[vertex] == UNVISITED) {
...
template <class ElemType>
AdjMatrixDirGraph<ElemType>::AdjMatrixDirGraph(ElemType * vertex, int vexNum) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	if (vexNum < 0) {
...
//函数功能: 返回顶点个数
template <class ElemType>
int AdjMatrixDirGraph<ElemType>::getVertexCount() {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	return m_vertexSize;
...
//函数功能: 返回边数
template <class ElemType>
int AdjMatrixDirGraph<ElemType>::getEdgeCount() {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	return m_edgeSize;
...
template <class ElemType>
int AdjMatrixDirGraph<ElemType>::getVertex(ElemType & elem) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
...
//函数功能: 返回顶点元素值
template <class ElemType>
ElemType AdjMatrixDirGraph<ElemType>::getVertexElem(int vertex) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	if (vertex < 0 || vertex >= this->m_vertexSize) {
...
//函数功能: 得到某顶点的访问信息
template <class ElemType>
bool AdjMatrixDirGraph<ElemType>::getVisited(int vertex) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	if (vertex < 0 || vertex >= this->m_vertexSize) {
...
template <class ElemType>
int AdjMatrixDirGraph<ElemType>::getFirstAdjVertex(int vertex) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
...
template <class ElemType>
int AdjMatrixDirGraph<ElemType>::getNextAdjVertex(int vertex1, int vertex2) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
...
template <class ElemType>
bool AdjMatrixDirGraph<ElemType>::insertEdge(int vertex1, int vertex2) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	if (vertex1 < 0 || vertex1 >= m_vertexSize) {
	...
	if (this->m_matrix[vertex1][vertex2] == 0) {
		this->m_matrix[vertex1][vertex2] = 1;//如果是网,则将1改为边的权值
		m_edgeSize++;
		return true;
	}
	else {
...
template <class ElemType>
void AdjMatrixDirGraph<ElemType>::setGraph(ElemType * vertex, int vexNum) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	destroyGraphHelp();
...
template <class ElemType>
bool AdjMatrixDirGraph<ElemType>::setElem(int vertex, ElemType elem) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	if (vertex < 0 || vertex >= m_vertexSize) {
...
template <class ElemType>
bool AdjMatrixDirGraph<ElemType>::setVisited(int vertex) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	if (vertex < 0 || vertex >= m_vertexSize) {
...
template <class ElemType>
bool AdjMatrixDirGraph<ElemType>::deleteEdge(int vertex1, int vertex2) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	if (vertex1 < 0 || vertex1 >= m_vertexSize) {
...
//函数功能: 深度优先搜索
template <class ElemType>
void AdjMatrixDirGraph<ElemType>::DFSTraverse(int vertex, void(*visit)(ElemType &)) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
...
template <class ElemType>
void AdjMatrixDirGraph<ElemType>::BFSTraverse(int vertex, void(*visit)(ElemType &)) {
#ifdef DEBUG
	std::cout << "FUNC:" << __func__ << ",LINE:" << __LINE__ << std::endl;
#endif // DEBUG
	for (int i = vertex; i < m_vertexSize; i++) {
...
template<class ElemType>
void AdjMatrixDirGraph<ElemType>::FindArticul()
{
	countt = 1;
	visited[0] = 1;
...
template<class ElemType>
void AdjMatrixDirGraph<ElemType>::DFSArticul(int vertex) {
	visited[vertex] = min = ++countt;
	int vexTemp;
	for (vexTemp = this->getFirstAdjVertex(vertex); vexTemp != -1; vexTemp = this->getNextAdjVertex(vertex, vexTemp)) {
		if (visited[vexTemp] == 0) {
			DFSArticul(vexTemp);
			if (low[vexTemp] < min) min = low[vexTemp];
			if (low[vexTemp] >= visited[vertex]) order[index++] = vexTemp;
		}
...
template<class ElemType>
inline BinaryTree<ElemType>* AdjMatrixDirGraph<ElemType>::DFSForest()
{

	BinaryTree<ElemType> * tree = new BinaryTree<ElemType>(this->getVertexElem(0));
	this->setVisited(0);

	for (int i = 1; i < m_vertexSize;i++) {

		if (!this->getVisited(i)) {
			tree->insertLeftChild(tree->getRoot(), this->getVertexElem(i));
			DFSTree()
		}
		else {
			tree->insertRightChild(tree->getRoot(), this->getVertexElem(i));
		}
	}
	return NULL;
}
/*=================================特征成员函数实现完毕===============================*/
#endif // ADJMATRIXDIRGRAPH_H_INCLUDE
