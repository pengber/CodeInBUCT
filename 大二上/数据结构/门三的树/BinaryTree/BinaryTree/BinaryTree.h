...
//特征函数
	...
	//非递归遍历的前序遍历用中序遍历相似代码实现,贼好记忆
	void nonRecurPreOrderTwo(BinTreeNode<ElemType> * root, void(*visit)(ElemType &));
...
/*================================特征函数实现完毕=============================*/
template<class ElemType>
inline void BinaryTree<ElemType>::nonRecurPreOrderTwo(BinTreeNode<ElemType>* root, void(*visit)(ElemType &))
{
	BinTreeNode<ElemType> * cur = root;
	LinkStack<BinTreeNode<ElemType> *> stack;
