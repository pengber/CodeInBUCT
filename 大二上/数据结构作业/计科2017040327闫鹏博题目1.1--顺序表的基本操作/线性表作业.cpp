...
int main() {
	...
	SqList<int> list;
	while (cout << "请输入操作数:" << endl && cin >> opeNum) {
		switch (opeNum)
		{
		case(1): {
			...
			for (int i = 1; i <= length; i++) {
				cin >> tempElem;
				list.insertBehindAll(tempElem);
			}
			break;
		}
		case(2): {
			cout << "线性表长度为" << list.getLength() << endl;
			break;
		}
		case(3): {
			cout << "线性表容量为" << list.getCapacity() << endl;
			break;
		}
		case(4): {
		...
		case(6): {
			...
			cout << "请输入所插元素" << endl;
			cin >> tempElem;
			list.insert(tempPos, tempElem);
			break;
		}
		case(7): {
			cout << "请输入所插元素" << endl;
			cin >> tempElem;
			list.insertByVal(tempElem);
			break;
		}
		case(8): {
			cout << "请输入所插元素" << endl;
		...
		case(11): {
			cout << "请输入位置" << endl;
			cin >> tempPos;
			list.deleteElem(tempPos, tempElem);
			break;
		}
		case(12): {
			cout << "请输入值" << endl;
			cin >> tempElem;
			list.deleteElemByVal(tempElem);
			break;
		}
		case(13): {
			list.clean();
