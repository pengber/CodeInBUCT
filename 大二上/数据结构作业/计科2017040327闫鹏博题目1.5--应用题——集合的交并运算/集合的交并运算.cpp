...
//初始条件:线性表对象已经创建
//操作结果:如果线性表为空或pos位置不合法返回0,成功返回1;
//无子函数
template <class ElemType>
...
//初始条件:线性表对象已经创建且pos合法
//操作结果:设置pos位置上的元素为elem
//无子函数
template <class ElemType>
...
int main() {
	cout << "*********************线性表菜单*******************" << endl;
	cout << "1.建立第一个线性表" << endl;
	cout << "2.查询线性表长度" << endl;
	cout << "3.查询线性表容量" << endl;
	cout << "4.判断线性表是否为空" << endl;
	cout << "5.查询元素在线性表中的位置" << endl;
	cout << "6.将元素插入到某个位置上" << endl;
	cout << "7.将元素插入到线性表中(按值插入)" << endl;
	cout << "8.将元素插入到线性表尾" << endl;
	cout << "9.修改某个位置的值" << endl;
	cout << "10.重置线性表" << endl;
	cout << "11.删除某个位置上的元素" << endl;
	cout << "12.删除某元素" << endl;
	cout << "13.清空线性表" << endl;
	cout << "14.显示线性表信息" << endl;
	cout << "15.对前两个线性表进行交运算" << endl;
	cout << "16.对前两个线性表进行并运算" << endl; 
	cout << "17.退出" << endl;
	cout << "**************************************************" << endl;
	int opeNum; 
	int capacity, length;
	int tempPos, tempElem;
	SqList<int> listA;
	while (cout << "请输入操作数:" << endl && cin >> opeNum && opeNum != 17) {
		switch (opeNum)
		{
		case(1): {
			cout << "请输入初始化线性表的大小:" << endl;
			cin >> length;
			cout << "请输入初始化线性表中元素:" << endl;
			for (int i = 1; i <= length; i++) {
				cin >> tempElem;
				listA.insertBehindAll(tempElem);
			}
			break;
		}
		case(2): {
			cout << "线性表长度为" << listA.getLength() << endl;
			break;
		}
		case(3): {
			cout << "线性表容量为" << listA.getCapacity() << endl;
			break;
		}
		case(4): {
			if (listA.isEmpty()) cout << "线性表为空" << endl;
			else cout << "线性表不为空" << endl;
			break;
		}
		case(5): {
			cout << "请输入需要查询的元素的值" << endl;
			cin >> tempElem;
			listA.getElem(tempPos, tempElem);
			cout << "元素的位置为" << tempPos << endl;
			break;
		}
		case(6): {
			cout << "请输入所插位置" << endl;
			...
			cout << "请输入所插元素" << endl;
			cin >> tempElem;
			listA.insert(tempPos, tempElem);
			break;
		}
		case(7): {
			cout << "请输入所插元素" << endl;
			cin >> tempElem;
			listA.insertByVal(tempElem);
			break;
		}
		case(8): {
			cout << "请输入所插元素" << endl;
		...
		case(9): {
			...
			cout << "请输入值" << endl;
			cin >> tempElem;
			listA.setElem(tempPos, tempElem);
			break;
		}
		case(10): {
			cout << "请输入重置后的大小" << endl;
			cin >> capacity;
			listA.reset(capacity);
			break;
		}
		case(11): {
			cout << "请输入位置" << endl;
			cin >> tempPos;
			listA.deleteElem(tempPos, tempElem);
			break;
		}
		case(12): {
			cout << "请输入值" << endl;
			cin >> tempElem;
			listA.deleteElemByVal(tempElem);
			break;
		}
		case(13): {
			listA.clean();
	...
	while (cout << "请输入操作数:" << endl && cin >> opeNum && opeNum != 17) {
		...
		case(1): {
			...
			for (int i = 1; i <= length; i++) {
				cin >> tempElem;
				listB.insertBehindAll(tempElem);
			}
			break;
		}
		case(2): {
			cout << "线性表长度为" << listB.getLength() << endl;
			break;
		}
		case(3): {
			cout << "线性表容量为" << listB.getCapacity() << endl;
			break;
		}
		case(4): {
			if (listB.isEmpty()) cout << "线性表为空" << endl;
			else cout << "线性表不为空" << endl;
			break;
		}
		case(5): {
			cout << "请输入需要查询的元素的值" << endl;
			cin >> tempElem;
			listB.getElem(tempPos, tempElem);
			cout << "元素的位置为" << tempPos << endl;
			break;
		}
		case(6): {
			...
			cout << "请输入所插元素" << endl;
			cin >> tempElem;
			listB.insert(tempPos, tempElem);
			break;
		}
		case(7): {
			cout << "请输入所插元素" << endl;
			cin >> tempElem;
			listB.insertByVal(tempElem);
			break;
		}
		case(8): {
			cout << "请输入所插元素" << endl;
		...
		case(9): {
			...
			cout << "请输入值" << endl;
			cin >> tempElem;
			listB.setElem(tempPos, tempElem);
			break;
		}
		case(10): {
			cout << "请输入重置后的大小" << endl;
			cin >> capacity;
			listB.reset(capacity);
			break;
		}
		case(11): {
			cout << "请输入位置" << endl;
			cin >> tempPos;
			listB.deleteElem(tempPos, tempElem);
			break;
		}
		case(12): {
			cout << "请输入值" << endl;
			cin >> tempElem;
			listB.deleteElemByVal(tempElem);
			break;
		}
		case(13): {
			listB.clean();
